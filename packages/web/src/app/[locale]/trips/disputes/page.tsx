        ...
        <FadeIn>
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Track the status of your dispute cases</p>
            </div>
          </div>
        </FadeIn>
        ...
        {disputes && disputes.length === 0 && (
          <FadeIn>
            <div className="text-center py-20">
              ...
              <h3 className="font-semibold text-gray-700 mb-1">No disputes filed</h3>
              ...
              return (
                ...
                >
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-gray-400 mt-1">Filed {date}</p>
                  </div>
