...
const STATUS_CONFIG: Record<string, { label: string; bg: string; text: string }> = {
  open:         { label: 'Open',         bg: 'bg-amber-100',  text: 'text-amber-800' },
  under_review: { label: 'Under review', bg: 'bg-blue-100',   text: 'text-blue-800'  },
        ...
        <FadeIn>
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Disputes filed for your properties</p>
            </div>
          </div>
        </FadeIn>
        ...
        {disputes && disputes.length === 0 && (
          <FadeIn>
            <div className="text-center py-20">
              ...
              <h3 className="font-semibold text-gray-700 mb-1">No disputes</h3>
              <p className="text-sm text-gray-500">
                When guests file disputes about your bookings, they will appear here.
              </p>
            </div>
          </FadeIn>
        )}
                ...
                >
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-gray-400 mt-1">
                      Filed by {d.raisedBy?.firstName ?? 'Guest'} on {date}
                    </p>
                  </div>
