          ...
          <div className="lg:col-span-2">
            ...
            <div className="rounded-2xl border border-neutral-200 overflow-hidden bg-white max-h-[400px] overflow-y-auto scrollbar-thin scrollbar-thumb-neutral-200 scrollbar-track-transparent">
              {[
                ...
                { emoji: '🗓️', label: t('reservations'), href: `/${locale}/hosting/reservations`, desc: `${pendingReservations?.length ?? 0} pending` },                { emoji: '💳', label: 'Pending Payments', href: `/${locale}/hosting/pending-payments`, desc: pendingPayments?.length ? `${pendingPayments.length} awaiting review` : 'InstaPay confirmations' },                { emoji: '💰', label: 'Earnings & Payouts', href: `/${locale}/hosting/earnings`, desc: 'Income & payout requests' },
