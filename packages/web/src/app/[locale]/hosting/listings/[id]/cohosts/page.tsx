  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-3xl bg-violet-50 shadow-inner">
        <UserCheck className="h-10 w-10 text-violet-400" strokeWidth={1.5} />
      </div>
      ...
      <h1 className="mt-1 text-2xl font-bold text-neutral-900">Co-host &amp; Team Management</h1>
      <p className="mt-3 max-w-sm text-sm text-neutral-500 leading-relaxed">
        Invite trusted people to help manage your listings — co-hosts who handle
        bookings and guests, and cleaners who get turnover notifications.
        This feature is almost ready and launching very soon.
      </p>
      <Link
        href={`/${locale}/hosting`}
