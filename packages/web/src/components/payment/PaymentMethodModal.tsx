...
type Method = 'select' | 'instapay' | 'opay-card';
        ...
        >
          ...
          <div className="px-6 pt-4 pb-6">
            ...
            <div className="space-y-3">
              {/* OPay Card — available to all users */}
              <button
              ...
              >
                ...
                <div className="rounded-lg bg-indigo-50 border border-indigo-100 px-3 py-2 text-xs text-indigo-700 leading-relaxed">
                  ✅ Download the <strong>InstaPay app</strong> and transfer instantly from any Egyptian bank.
                </div>
              </button>}
