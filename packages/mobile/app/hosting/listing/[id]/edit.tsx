...
import api, { propertiesApi, categoriesApi } from '@/lib/api';
...
export default function EditListingScreen() {
  ...
  // ---------------------------------------------------------------------------
  // Form state (initialized from fetched property)
  // ---------------------------------------------------------------------------
            ...
            >
              <Text
                className={`text-base font-semibold ${
                  spaceType === type.value ? 'text-brand' : 'text-gray-900'
                }`}
              >
                {type.label}
              </Text>
              ...
              <FlatList
                ...
                renderItem={({ item }) => {
                  ...
                  return (
                    <TouchableOpacity
                      onPress={() =>
                        setSelectedCategoryId(isActive ? null : item.id)
                      }
                      activeOpacity={0.8}
