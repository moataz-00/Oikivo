-- ============================================================
-- Migration 018: Create earnings and payouts tables
-- These tables were defined in schema.sql but never applied
-- via a migration file, causing "Table doesn't exist" errors.
-- ============================================================
